...
//MISO BEGIN
m.iso = (function (m, type, OBJECT, ARRAY, STRING, FUNCTION, miso, autoredraw, nodeCache, cellCache, redrawProp, pendingRequestsProp) {
    var end = m.deferred();
    var TEXT_NODE = 3;
    ...
    return end.promise;
})(m,type,OBJECT,ARRAY,STRING,FUNCTION,window.miso || {},autoredraw,nodeCache,cellCache,function () {
        if (arguments.length) redraw = arguments[0];
        return redraw;
    },function () {
        if (arguments.length) pendingRequests = arguments[0];
